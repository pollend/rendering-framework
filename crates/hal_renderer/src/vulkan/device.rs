use crate::{
    device::GPUCommonInfo,
    error::{HalError, HalError::Unhandled, HalResult},
    ffi,
    vulkan::*,
};
use std::{ffi::c_void, mem, mem::MaybeUninit, ptr};
...
pub struct VulkanGPUInfo {
    ...
    pub common: Option<Box<GPUCommonInfo>>,
}
...
impl VulkanGPUInfo {
    ...
    pub fn gpu(device: &ffi::vk::VkPhysicalDevice) -> HalResult<VulkanGPUInfo> {
